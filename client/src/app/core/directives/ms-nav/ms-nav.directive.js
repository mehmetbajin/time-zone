  ...
  function msNavIsFoldedDirective($document, $rootScope, msNavFoldService) {
    return {
      ...
      link: function (scope, iElement, iAttrs) {
        ...
        var isFoldedOpen = false;
        var body = angular.element($document[0].body);
        var openOverlay = angular.element('<div id="ms-nav-fold-open-overlay"></div>');
        var closeOverlay = angular.element('<div id="ms-nav-fold-close-overlay"></div>');
        var sidenavEl = iElement.parent();
